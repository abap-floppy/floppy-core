CLASS zfloppy_backend_fs_impl DEFINITION
  ...
  PUBLIC SECTION.
    INTERFACES zfloppy_backend_file_system.

    METHODS constructor IMPORTING dataset_api TYPE REF TO zfloppy_dataset_api.

  PRIVATE SECTION.
    DATA dataset_api TYPE REF TO zfloppy_dataset_api.
ENDCLASS.
