CLASS zfloppy_file_browser_config DEFINITION
  ...
  PUBLIC SECTION.
    ...
    DATA:
      configuration TYPE browser_configuration READ-ONLY.
    CLASS-METHODS:
      get_default_configuration RETURNING VALUE(result) TYPE REF TO zfloppy_file_browser_config.
    METHODS:
      constructor IMPORTING configuration TYPE browser_configuration.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
